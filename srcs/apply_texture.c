...
/*   Updated: 2019/04/08 10:16:20 by aducimet    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void			set_textures(t_wolf *wolf)
{
	...
	"ressources/Mario_brick.xpm", &wolf->tex.walls[0].width, &wolf->tex.walls[0].height);
	...
	"ressources/Mario_color.xpm", &wolf->tex.walls[1].width,
	...
	"ressources/Mario_kappa.xpm", &wolf->tex.walls[2].width, &wolf->tex.walls[2].height);
	...
	"ressources/Mario_mush.xpm", &wolf->tex.walls[3].width, &wolf->tex.walls[3].height);
