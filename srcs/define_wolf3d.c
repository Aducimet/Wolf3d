...
/*   Updated: 2019/04/08 10:46:53 by aducimet    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
{
	wolf->mapcolor[3][0] = RGB(68, 175, 235);
	wolf->mapcolor[3][1] = RGB(1, 6, 87);
	wolf->mapcolor[2][0] = RGB(255, 228, 196);
	wolf->mapcolor[1][0] = RGB(239, 155, 15);
	...
	wolf->mapcolor[1][2] = RGB(233, 201, 177);
	wolf->mapcolor[0][2] = RGB(86, 130, 3);
	wolf->mapcolor[2][3] = RGB(245, 245, 220);
...
t_wolf		*ft_define_wolf3d(void)
{
	...
	wolf->win_ptr = mlx_new_window(wolf->mlx_ptr, wolf->win_size_x,
	wolf->win_size_y, "Wolf3d || Aducimet");
